...
|--------------------|--------------------------------------|------------------|
| **1º SEM** |    **Painel de Mapeamento do Ecossistema industrial Regional**         | O projeto consiste em desenvolver uma dashboard em Power Bi, realizando analise e tratamento de dados para o desenvolvimento do mesmo e a visualização e coleta de informações para o desenvolvimento de inovação.  |


## Integrantes da equipe Icarus
...
| <a href="" target="_blank"><img src="https://img.shields.io/badge/Linkedin-blue?style=flat-square&logo=Linkedin&logoColor=white" alt="Linkedin"></a> <a href="" target="_blank"><img src="https://img.shields.io/badge/GitHub-111217?style=flat-square&logo=github&logoColor=white" alt="GitHub"></a>   | Davi Rodrigues | Dev Team 
...
Para mais informações, entre em contato com a equipe do projeto através do [icarus.fatec@gmail.com](mailto:icarus.fatec@gmail.com).

---

**Icarus Lab** - FATEC São José dos Campos
